...
import AvailablitySidebar from 'src/views/AvailablityListSidebar/AvailablitySidebar';
import ListAvailabiltyList from 'src/views/AvailablityListSidebar/ListAvailibiltyList/ListAvailabiltyList';
const salesData = [
  {
    stats: '245k',
    title: 'Sales',
...
const [bookingIDReport, setBookingIDReport] = useState(null);
  ...
  useEffect(() => {
    // Example to set loading to false after some async operation
    // Make sure you set loading to false at appropriate place in your code
    setLoading(false); // This should be called after the async operation is done
  }, []);
