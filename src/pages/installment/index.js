...
import AddInstallmentDetails from 'src/views/add-installment/AddInstallmentDetails';
      ...
      {!showProjectManage && (
        <>
          ...
          <Grid container spacing={6}>
            <Grid item xs={12}>
              {rows.length > 0 ? <AddInstallmentDetails /> : <AddInstallmentDetails />}
            </Grid>
          </Grid>
        </>
      )}

      {showProjectManage && <AddInstallmentDetails show={setShowProjectManage} />}
    </>
  );
};
