...
const Reciept = ({ bookingID }) => {
  ...
  //         `https://apiforcorners.cubisysit.com/api/api-fetch-projectbooking.php?BookingID=${bookingID}`
  //       );
    ...
    <>
      ...
      <InvoiceBox className="printableArea" ref={printRef}>
        ...
        >
          ...
          >
            <Typography style={{ fontSize: 26 }}>Mr Aman</Typography>
          </div>
        </div>
        ...
        >
          ...
          >
            <Typography style={{ fontSize: 17 }}>
              Payment Against Flat No. 907 On 9th Floor Of the Building Known as
