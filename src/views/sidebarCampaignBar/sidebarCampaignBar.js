...
const SidebarProjectMaster = ({ onEdit, onItemClick, onCreate }) => {
    ...
    return ( <
        ...
        <
        MenuItem onClick = {
            () => handleSortOptionChange("asc") } >
        Date Asc <
        /MenuItem> <
        MenuItem onClick = {
            () => handleSortOptionChange("desc") } >
        Date Desc <
        /MenuItem> <
        MenuItem onClick = {
            () => handleSortOptionChange("a-z") } >
        Name A - Z <
        /MenuItem> <
        MenuItem onClick = {
            () => handleSortOptionChange("z-a") } >
        Name Z - A <
        /MenuItem> <
        /Popover>
                ...
                List > {
                    ...
                    .map((item) => ( <
                        ...
                        ListItemText primary = { <
                            ...
                            /Typography> {
                                item.leadstatusName && ( <
                                    Chip label = { item.leadstatusName }
                                    size = "small"
                                    style = {
                                        {
                                            fontSize: 8,
                            ...
                            { color: "blue" } } >
                        {
                            getDateStatus(item.ContactCreateDate) && ( <
                                Chip label = { getDateStatus(item.ContactCreateDate) }
                                size = "small"
